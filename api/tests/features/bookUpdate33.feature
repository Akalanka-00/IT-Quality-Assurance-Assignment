Feature: Book Update33
  ...
  Scenario: Update a book with the same title but a different author
    Given a book is created with the same title and different author
    When the created book is updated with the same title and different author
