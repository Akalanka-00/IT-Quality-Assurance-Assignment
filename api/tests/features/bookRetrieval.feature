Feature: Book Retrieval
  ...
  Scenario: Attempt to retrieve a book by an invalid or null ID for a user role
    Given Set User Role to Admin
    When the user attempts to retrieve a book by an invalid or null ID
